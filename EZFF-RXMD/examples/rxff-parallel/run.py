...
def my_error_function(rr):
    ...
    md_gs_job.run(command='~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    ...
    # Run GULP calculation
    md_freq_scan_job.run(command='~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    # Read output from completed GULP job and clean-up
    ...
    # Run GULP calculation
    md_full_scan_job.run(command='~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    # Read output from completed GULP job and clean-up
