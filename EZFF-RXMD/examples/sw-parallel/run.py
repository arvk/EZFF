...
def my_error_function(variable_values):
    ...
    relaxed_job.run(command='~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    ...
    # Submit job and read output
    compressed_job.run(command='~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    # Read output from completed GULP job and cleanup job files
    ...
    # Submit job and read output
    expanded_job.run(command = '~/hpc_ankitmis/DowntimeSpring2019/gulp-5.1/Src/gulp')
    # Read output from completed GULP job and cleanup job files
