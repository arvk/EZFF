...
if __name__ == '__main__':
    ...
    obj.parameterize(num_epochs = 2)
    obj.set_algorithm('nsga2_mo_platypus', population_size = 16)
    obj.parameterize(num_epochs = 2)
    obj.set_algorithm('ctaea_mo_pymoo', population_size = 16)
    obj.parameterize(num_epochs = 2)
    obj.set_algorithm('rvea_mo_pymoo', population_size = 16)
    obj.parameterize(num_epochs = 2)
    obj.set_algorithm('nsga3_mo_platypus', population_size = 16)
    obj.parameterize(num_epochs = 2)
